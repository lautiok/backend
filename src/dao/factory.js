  ...
  switch (persistence) {
    case "mongo":
      ...
      const { default: UsersMongoDAO } = await import(
        "../dao/mongo/users.mongo.dao.js"
      );
      const { default: TicketsMongoDAO } = await import(
        "../dao/mongo/tickets.mongo.dao.js"
      );
      const { default: MessagesMongoDAO } = await import(
        "../dao/mongo/messages.mongo.dao.js"
      );
    ...
    case "fs":
      const { default: ProductsFsDAO } = await import(
      ...
      const { default: TicketsFsDAO } = await import(
        "../dao/fs/tickets.fs.dao.js"
      );
      const { default: MessagesFsDAO } = await import(
        "../dao/fs/messages.fs.dao.js"
      );
