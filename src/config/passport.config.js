        ...
        try {
          ...
          if (!first_name || !last_name || !username || !password) {
            return done(
              null,
              false,
              "Los campos nombre, apellido, correo electrónico y contraseña son obligatorios"
            );
          }
          ...
          if (user) {
            return done(
              null,
              false,
              `Ya existe un usuario registrado con el correo electrónico ${username}`
            );
          }
        ...
        try {
          ...
          if (!email || !password) {
            return done(
              null,
              false,
              "Los campos correo electrónico y contraseña son obligatorios"
            );
          }
          if (
          ...
          if (!user) {
            return done(
              null,
              false,
              `No existe un usuario registrado con el correo electrónico ${username}`
            );
          }
